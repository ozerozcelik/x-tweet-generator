      ...
      <div className="container mx-auto px-4 py-16">
        <nav className="flex items-center justify-between mb-16">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/auth/register" className="px-6 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition">
              Kayıt Ol
            </Link>
          </div>
        </nav>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
            ...
            <span className="text-blue-400"> Tweet Üret</span>
          </h1>
          ...
          <div className="flex gap-4 justify-center mb-16">
            <Link href="/auth/register" className="px-8 py-4 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-semibold transition transform hover:scale-105">
              Ücretsiz Başla
            </Link>
            <Link href="#features" className="px-8 py-4 border border-slate-600 text-white rounded-lg font-semibold hover:bg-slate-800 transition">
              Özellikler
            </Link>
          </div>
